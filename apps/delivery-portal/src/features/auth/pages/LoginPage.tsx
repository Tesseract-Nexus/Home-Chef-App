      ...
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-muted-foreground">
            Sign in to manage deliveries and fleet operations
          </p>
        </div>
        ...
        {accessDenied && (
          <div className="rounded-xl border border-destructive/30 bg-destructive/5 p-4 text-sm text-destructive">
            Access denied. Only authorized delivery staff can sign in to this portal.
          </div>
        )}
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                Only pre-authorized delivery staff and fleet managers can sign in.
        ...
        <p className="text-center text-xs text-muted-foreground">
          Fe3dr Delivery Portal &middot; Staff Only
        </p>
      </div>
    </div>
  );
