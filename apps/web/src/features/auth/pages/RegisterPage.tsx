...
import { Eye, EyeOff, Mail, Lock, User, Phone, ChefHat, Check } from 'lucide-react';
        ...
        <div className="mx-auto w-full max-w-sm lg:w-96">
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <Button variant="outline" disabled={isLoading} className="py-2.5">
              ...
              <div className="space-y-2">
                <label className="flex items-start gap-2 cursor-pointer">
                  <input
                    ...
                    className="mt-1 h-4 w-4 rounded border-gray-300 text-brand-600 focus:ring-brand-500 transition-colors"
                  />
